...
#include "ros_2dnav/pose_2d.hpp"
#include "ros_2dnav/ackermann_kinematics.hpp"
#include "ros_2dnav/scan_simulator_2d.hpp"

#include "ros_2dnav/car_state.hpp"
#include "ros_2dnav/car_params.hpp"
#include "ros_2dnav/ks_kinematics.hpp"
#include "ros_2dnav/st_kinematics.hpp"
#include "ros_2dnav/precompute.hpp"
...
private:
    ...
    // Listen for commands // modified by HTY
...
public:
    ...
    RacecarSimulator(): im_server("racecar_sim") {
        ...
        pose_rviz_topic, odom_topic, imu_topic, cmd_topic;
        n.getParam("drive_topic", drive_topic);
        n.getParam("cmd_topic", cmd_topic); // modified by HTY
        ...
        // Start a subscriber to listen to drive commands // modified by HTY
        cmd_sub = n.subscribe(cmd_topic, 1, &RacecarSimulator::cmd_callback, this);
