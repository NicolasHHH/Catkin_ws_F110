...
class pure_pursuit:
	...
	print("opp position",x,y)
        ...
        transformed_point = self.tf_listener.transformPoint("opp_racecar/base_link",aheadPoint)
...
if __name__ == '__main__':
    with open("/home/tianyang/f110_ws/waypoints_global.csv" ,'r') as f: 
        cr = csv.reader(f)
